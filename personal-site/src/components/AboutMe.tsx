...
export default function AboutMe() {
  return (
    <section id = "about" className="relative h-auto w-full flex flex-row items-center justify-center px-4 md:px-8 py-16 md:py-0">
        {/* Left Side - Image Content */}
        {Star_Map(20)}
        <div className="w-48 sm:w-1/5 md:w-1/3 rounded-full overflow-hidden border-4 border-gray-300 shadow-lg flex-shrink-0 mb-8 md:mb-0">
              <img
                src={Shreeya}
                alt="Profile"
        ...
        <div className="md:col-span-1 px-0 md:px-16 text-center md:text-left md:ml-8">
            <h1 className="font-boldbloom text-2xl sm:text-3xl md:text-5xl font-bold mb-6">ABOUT.</h1>
