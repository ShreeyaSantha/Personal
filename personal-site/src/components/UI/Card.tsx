...
export default function Card({title, description, languages}: CardProps) {
    return (
        <div className="h-64 md:h-1/3 md: transition-300 group relative flex aspect-[5/4] flex-col justify-evenly overflow-hidden rounded-3xl border border-grey3 px-6 pb-8 hover:border-grey2"> 
